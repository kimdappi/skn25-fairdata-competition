...
export FAIRDATA_EXPERIMENT_TAG=V2-E1
PORT=8101
RESULTS_DIR=results/V2-E1
LOG=/tmp/v2_e1_server.log
EVAL_LOG=/tmp/v2_e1_eval.log
...
SERVER_PID=$!
echo "$SERVER_PID" > /tmp/v2_e1_server.pid
...
python3 -u scripts/evaluate_local.py \
  ...
  --experiment-tag V2-E1 | tee "$EVAL_LOG"
