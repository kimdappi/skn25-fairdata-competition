...
EXP_TAG="V2-E2-BGEM3-DS-D30-S50"
export EXP_TAG
PORT="8016"
...
export FAIRDATA_RERANK_TOP_N=50
export FAIRDATA_RERANK_WEIGHT="${FAIRDATA_RERANK_WEIGHT:-1.0}"
export FAIRDATA_INDEX_NAMESPACE="dense_bgem3__sparse_bgem3__multivector_off__d30_s50_rtop50"
export FAIRDATA_DENSE_TOP_K=30
export FAIRDATA_SPARSE_TOP_K=50
