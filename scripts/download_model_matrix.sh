...
EMBEDDING_ROOT_DIR="${EMBEDDING_ROOT_DIR:-${MODELS_DIR}/embedding}"
RERANKER_ROOT_DIR="${RERANKER_ROOT_DIR:-${MODELS_DIR}/reranker}"
LLM_ROOT_DIR="${LLM_ROOT_DIR:-${MODELS_DIR}/llm}"
...
주의
  ...
  - 기본 저장 경로는 models/embedding, models/reranker, models/llm 입니다.
EOF
}
...
# Embedding models
EMBEDDING_DIR_BGE_M3="${EMBEDDING_DIR_BGE_M3:-${EMBEDDING_ROOT_DIR}/bge-m3}"
EMBEDDING_DIR_MULTILINGUAL_E5_LARGE="${EMBEDDING_DIR_MULTILINGUAL_E5_LARGE:-${EMBEDDING_ROOT_DIR}/multilingual-e5-large}"
EMBEDDING_DIR_KO_SBERT_NLI="${EMBEDDING_DIR_KO_SBERT_NLI:-${EMBEDDING_ROOT_DIR}/ko-sbert-nli}"
EMBEDDING_DIR_JINA_EMBEDDINGS_V4="${EMBEDDING_DIR_JINA_EMBEDDINGS_V4:-${EMBEDDING_ROOT_DIR}/jina-embeddings-v4}"
EMBEDDING_DIR_GTE_MULTILINGUAL_BASE="${EMBEDDING_DIR_GTE_MULTILINGUAL_BASE:-${EMBEDDING_ROOT_DIR}/gte-multilingual-base}"
EMBEDDING_DIR_KURE_V1="${EMBEDDING_DIR_KURE_V1:-${EMBEDDING_ROOT_DIR}/KURE-v1}"
EMBEDDING_DIR_SNOWFLAKE_ARCTIC_EMBED_L_V20_KO="${EMBEDDING_DIR_SNOWFLAKE_ARCTIC_EMBED_L_V20_KO:-${EMBEDDING_ROOT_DIR}/snowflake-arctic-embed-l-v2.0-ko}"
...
# Reranker models
RERANKER_DIR_BGE_RERANKER_V2_M3="${RERANKER_DIR_BGE_RERANKER_V2_M3:-${RERANKER_ROOT_DIR}/bge-reranker-v2-m3}"
RERANKER_DIR_BGE_RERANKER_V2_GEMMA="${RERANKER_DIR_BGE_RERANKER_V2_GEMMA:-${RERANKER_ROOT_DIR}/bge-reranker-v2-gemma}"
RERANKER_DIR_BGE_RERANKER_V25_GEMMA2_LIGHTWEIGHT="${RERANKER_DIR_BGE_RERANKER_V25_GEMMA2_LIGHTWEIGHT:-${RERANKER_ROOT_DIR}/bge-reranker-v2.5-gemma2-lightweight}"
RERANKER_DIR_JINA_RERANKER_V3="${RERANKER_DIR_JINA_RERANKER_V3:-${RERANKER_ROOT_DIR}/jina-reranker-v3}"
RERANKER_DIR_KO_RERANKER="${RERANKER_DIR_KO_RERANKER:-${RERANKER_ROOT_DIR}/ko-reranker}"
...
# LLM models
LLM_DIR_QWEN25_7B_INSTRUCT="${LLM_DIR_QWEN25_7B_INSTRUCT:-${LLM_ROOT_DIR}/qwen2.5-7b-instruct}"
LLM_DIR_QWEN3_8B="${LLM_DIR_QWEN3_8B:-${LLM_ROOT_DIR}/qwen3-8b}"
LLM_DIR_QWEN3_4B="${LLM_DIR_QWEN3_4B:-${LLM_ROOT_DIR}/qwen3-4b}"
LLM_DIR_EXAONE_35_78B_INSTRUCT="${LLM_DIR_EXAONE_35_78B_INSTRUCT:-${LLM_ROOT_DIR}/exaone-3.5-7.8b-instruct}"
LLM_DIR_LLAMA3_OPEN_KO_8B="${LLM_DIR_LLAMA3_OPEN_KO_8B:-${LLM_ROOT_DIR}/llama-3-open-ko-8b}"
LLM_DIR_LLAMA_VARCO_8B_INSTRUCT="${LLM_DIR_LLAMA_VARCO_8B_INSTRUCT:-${LLM_ROOT_DIR}/llama-varco-8b-instruct}"
