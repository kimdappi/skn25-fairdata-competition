...
class HybridSearchPipeline:
    ...
    def __init__(self, corpus_store: CorpusStore, router: QueryRouter) -> None:
        ...
        self.multivector_weight = resolve_multivector_weight()
        self.multivector_qm_only = use_multivector_only_for_qm()
    ...
    def analyze_query(self, question: str, query_id: str | None = None) -> QueryAnalysis:
    ...
    def run_retrieval_paths(
        ...
        *,
        ...
        use_multivector_for_query = self.enable_multivector and (
            not self.multivector_qm_only
            or (analysis.query_id or "").startswith("Q-M")
        )
        if use_multivector_for_query and self.multivector_engine is not None:
    ...
    def fuse_hits(self, analysis: QueryAnalysis, trace: RetrievalTrace) -> dict[str, float]:
        ...
        weights = {
            "dense": 0.95,
            "sparse": 1.0,
            "multivector": self.multivector_weight,
        }
        if self.use_rrf:
            rankings = {
    ...
    def search(self, question: str, top_k: int = 5, query_id: str | None = None) -> list[Chunk]:
        ...
        analysis = self.analyze_query(question, query_id=query_id)
